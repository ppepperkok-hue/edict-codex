...
def test_done():
    ...
    cmd_state('JJC-TEST-E2E-08', 'Menxia', '方案提交门下省审议')
    cmd_state('JJC-TEST-E2E-08', 'Assigned', '门下省准奏，转尚书省')
    cmd_state('JJC-TEST-E2E-08', 'Doing', '尚书省派发六部执行')
    cmd_done('JJC-TEST-E2E-08', '/tmp/output.md', '任务已完成')
    cmd_state('JJC-TEST-E2E-08', 'Done', '尚书省汇总完成，提交御批')
    cmd_confirm('JJC-TEST-E2E-08', 'approve', '尚书省确认收口')
...
def test_done_not_overwritable():
    ...
    cmd_state('JJC-TEST-E2E-09', 'Menxia', '方案提交门下省审议')
    cmd_state('JJC-TEST-E2E-09', 'Assigned', '门下省准奏，转尚书省')
    cmd_state('JJC-TEST-E2E-09', 'Doing', '尚书省派发六部执行')
    cmd_done('JJC-TEST-E2E-09', '/tmp/output.md', '任务已完成')
    cmd_state('JJC-TEST-E2E-09', 'Done', '尚书省汇总完成，提交御批')
    cmd_confirm('JJC-TEST-E2E-09', 'approve', '尚书省确认收口')
